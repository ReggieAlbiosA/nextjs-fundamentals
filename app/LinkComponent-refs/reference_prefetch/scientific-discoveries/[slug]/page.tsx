...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
    // Changed params.id type from number to string to match Record keys
    const { slug } = await params; // ✅ Await the params object properly
    const pageData = scientificDiscoveries[slug]; // Use the awaited slug
